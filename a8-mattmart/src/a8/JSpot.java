...
public class JSpot extends JPanel implements MouseListener, Spot {
	...
	//also new
	public JSpot copy(JSpot c) {
		//this.setBackground(Color.BLACK);
		this._spot_color = c._spot_color;
		this._highlight_color = c._highlight_color;
		//skipped board
		//this._board = c._board;
		this._x = c._x;
		this._y = c._y;
		if (c.getLife().equals("A")) {
			this.cell = Life.ALIVE;
		} else {
			this.cell =Life.DEAD;
		}
		return this;
	...
	public double setRandNum(double num) {
